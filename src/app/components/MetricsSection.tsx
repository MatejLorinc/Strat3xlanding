  ...
  return (
    <section className="relative w-full py-12 lg:py-20">
      <div className="max-w-[1400px] mx-auto px-[18px] lg:px-8">
        {/* Section Header */}
        <div className="flex flex-col gap-6 lg:gap-8 mb-8 lg:mb-12 text-black uppercase text-center">
  ...
  return (
    <div className="w-full group">
      ...
      <div
        ...
        `}
      >
        <div className="flex flex-col justify-center xl:justify-end items-center xl:items-start flex-1 py-[22px] xl:pt-14 px-[16px] lg:px-[39.326px] xl:pb-[22px] gap-[30px] xl:gap-[120px]">
          {/* Icon with decorative backgrounds */}
          <div className="relative flex flex-col items-center xl:items-start w-full">
            <div className="relative flex justify-center w-full">
              <div className="relative">
                {/* Background Blobs centered with icon */}
                <div className="bg-[#b9b4d0] h-[27.694px] w-[97.742px] opacity-26 absolute -left-[10px] top-[13.03px]" />
                <div className="bg-[#dfbcd9] h-[27.694px] w-[97.742px] opacity-26 absolute left-[55px] top-[73.31px]" />
          ...
          {/* Value */}
          <div className="flex flex-col items-center xl:items-start pb-[8.848px]">
      ...
      <div
        ...
        `}
      >
        <p className={`font-['Sora'] font-semibold text-[11px] text-black text-center tracking-[2.2px] uppercase leading-[17px] underline underline-offset-[3px] decoration-[1px] transition-all duration-300 ${underline ? 'decoration-black' : 'decoration-transparent group-hover:decoration-black'}`}>
          {label}
        </p>
      </div>
    </div>
...
function ChartIcon() {
  return (
    <div className="w-[115.067px] h-[84.473px] relative mt-0">
...
function MoneyIcon() {
  return (
    <div className="w-[83.47px] h-[83.47px] relative flex justify-center items-center">
      <svg className="block w-full h-full" fill="none" viewBox="0 0 68.9801 83.4696" preserveAspectRatio="xMidYMid meet">
        <g>
...
function GlobeIcon() {
  return (
    <div className="w-[88px] h-[88px] relative">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="44 -1 88 89">
        <g>
          <g>
...
function TransactionIcon() {
  return (
    <div className="w-[72.784px] h-[88.439px] relative">
